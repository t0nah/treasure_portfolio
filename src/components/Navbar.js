    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-gray-900 via-black to-gray-900 shadow-lg">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <ul className="hidden md:flex space-x-8 text-gray-100 font-medium">
          ...
          <li>
            <a
              href="#projects" className="hover:text-green-400 transition duration-300">
              Projects
            </a>
          </li>
          <li>
          ...
          <li><a href="#resources" className="hover:text-yellow-400 transition duration-300">Resources</a></li>
          <li>
            <a
              href="#dev-setup"className="hover:text-pink-400 transition duration-300">Dev Setup
            </a>
          </li>
        </ul>
