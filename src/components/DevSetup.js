...
const DevSetup = () => {
  return (
    <section
      id="dev-setup"
      className="py-16 bg-gradient-to-b from-gray-800 to-black text-gray-100"
    >
      <div className="container mx-auto px-6">
        ...
        <p className="text-lg text-gray-400 text-center mb-12 max-w-3xl mx-auto">
          A well-organized environment helps me stay productive. Here’s a peek
          into the tools that power my workflow:
        </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="relative p-6 bg-gray-700 rounded-xl shadow-lg transform hover:scale-105 hover:bg-gray-600 transition-all">
            ...
            <p className="text-gray-300">
              Docker for development, Git for version control
            </p>
          </div>
          ...
          <div className="relative p-6 bg-gray-700 rounded-xl shadow-lg transform hover:scale-105 hover:bg-gray-600 transition-all">
            ...
            <p className="text-gray-300">
              Browser dev tools, Postman for API testing
            </p>
          </div>
        </div>
      </div>
